...
class inventory
{
        ...
        for(int i=0;i<60;i++)
            ...
            if(ch1==1)
            {
                for(;;)
                {
                    ...
                    do
                    {
                    System.out.print("Do you have more records to enter(y/n): ");
            ...
            if(ch1==2)
            {
                for(;;)
                {
                    System.out.print("Enter the item number you want to delete(eg.I001): ");
                    in=br.readLine().trim();
                    v1=validate(in);
                    if(v1)
                    {
            ...
            if(ch1==3)
            {
                for(;;)
                {
                    System.out.print("Enter the item number for changing ROQ(eg.I001): ");
                    in=br.readLine().trim();
                    v1=validate(in);
                    if(v1)
                        break;
                ...
                do
                {
                    ...
                    while(true)
                    {         
                        System.out.println("Old Roq= "+datafeed(1,in));
                        try
                        {
                            System.out.print("Enter the new ROQ(>=2): ");
            ...
            if(ch1==4)
            {
                for(;;)
                {
                    System.out.print("Enter the item number for changing ROL(eg.I001): ");
                    in=br.readLine().trim();
                    v1=validate(in);
                    if(v1)
                        break;
                ...
                do
                {
                    while(true)
                    {         
                        System.out.println("Old Rol= "+datafeed(3,in));
                        try
                        {
                            System.out.print("Enter the new ROL(>=2): ");
                            ne=Integer.parseInt(br.readLine().trim());
                        }catch(NumberFormatException ravi)
                        {            
                            continue;
    ...
    // used for extracting qoh,rol,roq
    // -------------------------------

    int datafeed(int p, String in)throws Exception 
    {
        int n=0;
        boolean v=false;
        ...
        if(f.exists())
        {
            ...
            while(to!=-1)
            {
                if(to==-3)
                {
                    if(st.sval.equalsIgnoreCase(in))
                        v=true;
                }
                if(to==-2)
                {
    ...
    void input()throws Exception
    {
        ...
        {        	
        	try
        	{
                ...
                System.out.print("Enter Quantity on Hand(>0): ");
        ...
        do
        {
            System.out.print("Enter Re-order level(>=2): ");
            t1=br.readLine().trim();
            ctr1=0;
        ...
        do
        {
            System.out.print("Enter Re-order quantity(>=ROL): ");
            t1=br.readLine().trim();
            ctr1=0;
            for(int i=0;i<t1.length();i++)
            {
                    ...
                    if(to==-3)
                    {
                        if(x==1 || x==3)
                            ...
                            else
                            {
                                ...
                                {
                                    if(ou[i+1].charAt(0)=='0')
                                    {
                                        ou[i]+="0";
                                        ou[i+1]=ou[i+1].substring(1);
                                    }
                                }*/
    ...
    // prints the record of the ino recieved
    // -------------------------------------

    void qu(String in)throws Exception
    {
        FileReader fr=new FileReader("master.dat");
        StreamTokenizer st=new StreamTokenizer(fr);
        st.eolIsSignificant(true);
        ...
        while(to!=-1)
        {
            if(to==-3)
            {
                if(sr==1)
                {
                    if(in.equalsIgnoreCase(st.sval))
                    {
                        System.out.println("INO: "+st.sval);
                        q=true;
                    }
                    sr++;
                }
                else if(sr==2)
                {
                    sr=1;
                    if(q)
                        System.out.println("Des: "+st.sval);
                }
            }
            if(to==-2)
            {
                if(nu==1)
                {
                    nu++;
                    if(q)
                        System.out.println("Roq: "+st.nval);
                }
                else if(nu==2)
                {
                    nu++;
                    if(q)
                        System.out.println("Qoh: "+st.nval);
                }
                else if(nu==3)
                {
                    nu=1;
                    if(q)
                        System.out.println("Rol: "+st.nval);
                }
            }
            if(to==10)
            {
    ...
    // prints the mothly and daily reports
    // -----------------------------------
    ...
    void rolc(int ctr1)throws Exception
    {
        ...
        if(f1.exists())
        {
            ...
            for(int i=0;i<ctr1;i++)
            {
                if(qoh[i]<rol[i])
                {
                    System.out.print("The qoh for "+ino[i]+" is lesser than Rol, Do you want to reorder?(y/n) ");    
                    c=br.readLine().trim().charAt(0);
                    if(c=='y' || c=='Y')
                        update(ino[i],3,0);
                }
    ...
    // update records t=1->Rol t=2->Roq t=3->Qoh t=4->sell
    // ---------------------------------------------------
                ...
                else if(ctr2==2)
                {
                    ...
                    if(f)
                    {
                        ...
                        else if(t==4)
                        {
                            ...
                            System.out.println("Qoh: "+(st.nval-ch));
                        }
                        else
                            dos.writeUTF(String.valueOf(st.nval).trim());
                    }
    ...
    void sell()throws Exception
    {
        ...
        if(f.exists())
        {
            ...
            while(true)
        	{        	
            System.out.println("Qoh= "+datafeed(2,in));

            try
        	{
        	
                    System.out.print("Enter the Quatity Sold(<=QOH): ");
