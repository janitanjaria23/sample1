...
class inventory
{
    ...
    {
        int ch=0,ch1=0,ch2=0,ch3=0,ch4=0,ne=0;
        char c=' ';
        String in="",re="";
        ...
        if(ch==1)
        {
            ...
            if(ch1==5)
            {
                for(;;)
                {
                    System.out.print("Enter the item number for checking: ");
                    in=br.readLine().trim();
                    v1=validate(in);
                    if(v1)
                        break;
                ...
                System.out.println(qcheck(in,0,2));
                if(qcheck(in,0,2))
                {
                    System.out.print("Do you wish to reorder? ");
                    c=br.readLine().trim().charAt(0);
                    if(c=='y' || c=='Y')
                        update(in,3,0);
                }
    ...
    void input()throws Exception
    {
        ...
        do
        {
            ...
            rol=Integer.parseInt(br.readLine().trim());
        }while(rol<2);
        do
        {
            System.out.print("Enter Re-order quantity: ");
            roq=Integer.parseInt(br.readLine().trim());
        }while(roq<2);
    }
            ...
            if(to==-2)
            {
                ...
                else if(ctr2==2)
                {
                    ...
                    if(f)
                    {
                        if(t==3)
                        {
                            dos.writeUTF(String.valueOf((st.nval+ro)));
                        }
                        else if(t==4)
                        {
                            dos.writeUTF(String.valueOf((st.nval-ch)));
        ...
        if(f3.exists())
        {
            ...
            while(to!=-1)
            {
                ...
                if(to==-2)
                {
                    if(z)
                    {
                        d.writeUTF(String.valueOf((t3=(rotc(in)+1))));
                    }
                    else
                    {
                        d.writeUTF(String.valueOf(st1.nval));
                    }
                }
                if(to==10)
                {
    ...
    void sell()throws Exception
    {
        ...
        if(f.exists())
        {
            ...
            for(;;)
            {
                ...
                dos.writeUTF(s);
                dos.writeUTF(in);
                dos.writeUTF(String.valueOf(qs));
                dos.writeUTF("\n");
